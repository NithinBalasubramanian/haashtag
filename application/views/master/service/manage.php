...
<div class="row  mb-4">
    ...
    <div class="form-group col-md-12">
        <label for="username"><?php echo lang('service_name') ?> <span class="m-required"></span></label>
...
<?php echo form_hidden('edit_id', $this->generals_func->set_field($edit, 'service_id')) ?>
