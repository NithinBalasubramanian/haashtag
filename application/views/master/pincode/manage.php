...
?>
    ...
    <div class="form-group col-md-12">
        <label for="username"><?php echo lang('city') ?> <span class="m-required"></span></label>
<?php echo form_dropdown('city_id', $city_option, $this->generals_func->set_field($edit, 'city_id'), 'class="form-control select2 js-data-ajax" data-endpoint="locations" data-placeholder="' . lang('select_a_city') . '"     id="city_options"');
?>
    </div>
    <div class="form-group col-md-12">
        <label for="username"><?php echo lang('pincode') ?> <span class="m-required"></span></label>
        <?php echo form_input(array('name' => 'pincode', 'id' => 'pincode', 'value' => $this->generals_func->set_field($edit, 'pincode'), 'class' => 'form-control is_alphabets', 'minlength' => '1', 'maxlength' => '12', 'required' => 'required')); ?>
...
<?php echo form_hidden('edit_id', $this->generals_func->set_field($edit, 'pincode')) ?>
