...
class digestauth {
    ...
    public function authenticate($realm = null, $username = null) {
        ...
        // Parse auth headers
        if (!($data = $this->http_digest_parse($auth_headers)))
            return (object) array('status' => 'invalid', 'message' => 'invalid_http_data'); // Bad credentials. TODO: What sort of meaningful error can we give here?
