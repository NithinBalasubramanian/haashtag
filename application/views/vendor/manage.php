    ...
    <div class="col-sm-12">
        ...
        <div class="row  mb-4">
            <div class="form-group col-md-2">
                ...
                <?php echo form_input(array('name' => 'name', 'id' => 'vendor_name', 'value' => $this->generals_func->set_field($edit, 'name'), 'class' => 'form-control is_alphabets', 'minlength' => '1', 'maxlength' => '100', 'required' => 'required')); ?>
                <?php echo form_error('vendor_name'); ?>
            </div>

            <div class="form-group col-md-2">
                <label for="username"><?php echo lang('vendor_code') ?> <span class="m-required"></span></label>
                <?php echo form_input(array('name' => 'vendor_code', 'id' => 'vendor_code', 'value' => $this->generals_func->set_field($edit, 'vendor_code'), 'class' => 'form-control is_alphabets', 'minlength' => '1', 'maxlength' => '100', 'required' => 'required')); ?>
...
?>
        ...
        <?php echo form_hidden('edit_id', $this->generals_func->set_field($edit, 'vendor_id')) ?>
