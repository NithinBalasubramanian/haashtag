  ...
  */
  class Datatables
  {
    ...
    */
	...
	public function sl_column()
    {
      $this->sl_columns['nos'] =($this->ci->input->post('iDisplayStart')) ? $this->ci->input->post('iDisplayStart')+1: 1;
      return $this;
    }
    /**
    * Unset column
    ...
    */
    protected function produce_output($charset)
    {
      ...
      {
		if(!empty($this->sl_columns))
		{
			//array_unshift($row_val,$this->sl_columns['nos']++);
