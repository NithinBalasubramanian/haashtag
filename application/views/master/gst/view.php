...
<script>
    ...
    function  getReport()
    {
        ...
        var colNamesm = ["Name","Gst Value in %","Effective Date"];

        var colModelm = [

            {name: 'name', align: 'left', index: 'code', sorttype: 'string', searchoptions: {sopt: ['eq', 'bw', 'bn', 'cn', 'nc', 'ew', 'en']}, resizable: true},
            {name: 'value', index: 'value', resizable: true},
            {name: 'effective_date', index: 'value', resizable: true},
        ];
