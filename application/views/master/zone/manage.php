...
<div class="row  mb-4">
    ...
    <div class="form-group col-md-12">
        <label for="username"><?php echo lang('zone_code') ?> <span class="m-required"></span></label>
        <?php
        if ($this->generals_func->set_field($edit, 'zone_code') != "") {
            echo form_input(array('name' => 'zone_code', 'id' => 'zone_code', 'value' => $this->generals_func->set_field($edit, 'zone_code'), 'class' => 'form-control is_alphabets', 'minlength' => '1', 'disabled' => 'disabled', 'maxlength' => '5',));
        } else {
            echo form_input(array('name' => 'zone_code', 'id' => 'zone_code', 'value' => $this->generals_func->set_field($edit, 'zone_code'), 'class' => 'form-control is_alphabets', 'minlength' => '1', 'maxlength' => '5', 'required' => 'required'));
            ?>
