...
<script>
    ...
    function  getReport()
    {
       ...
       var colNamesm = ["Code", "Name", "Contact No", "Email ID","Description"];

        var colModelm = [

            {name: 'Code', align: 'left', index: 'code', sorttype: 'string', searchoptions: {sopt: ['eq', 'bw', 'bn', 'cn', 'nc', 'ew', 'en']}, resizable: true},
            {name: 'name', index: 'name', resizable: true},
            {name: 'contact no', index: 'contact_no', resizable: true},
            {name: 'email id', index: 'email_id', resizable: true},
             
            {name: 'description', index: 'description', resizable: true},
        ];
